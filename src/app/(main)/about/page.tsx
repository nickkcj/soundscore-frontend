  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-pink-50 rounded-full filter blur-2xl opacity-40 -translate-x-1/2 -translate-y-1/2" />
      </div>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Rate Albums</h3>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Connect & Follow</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Discover New Music</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Join Groups</h3>
              <p className="text-gray-600">
        ...
        <section className="text-center">
          <div className="bg-gradient-to-r from-pink-500 to-purple-600 rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/register"
                className="inline-flex items-center justify-center px-8 py-3 bg-white text-pink-600 font-semibold rounded-full hover:bg-pink-50 transition-colors shadow-md"
              >
                Get Started Free
              </Link>
              <Link
